...
| 012 | Adopt airlock/screen + airlock/detect as one screening core | P2 | L | airlock v0.1.0 | TODO (absorbs 011; build the new code, then one null-and-rescore deploy regenerates under the threat scale. Plan written at `2c7a482`) |
